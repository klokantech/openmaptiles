...
RETURNS TABLE(osm_id bigint, geometry geometry, class text, ramp int, oneway int, brunnel TEXT, service TEXT) AS $$
    ...
    FROM (
        ...
        WHERE NOT is_area AND (
            zoom_level BETWEEN 8 AND 10 AND (
        ...
        WHERE zoom_level BETWEEN 1 AND 6
        ...
        WHERE zoom_level = 7 AND (railway='rail' AND service = '')
        UNION ALL
        ...
        WHERE zoom_level BETWEEN 8 AND 10 AND (railway='rail' AND service = '')
        UNION ALL
